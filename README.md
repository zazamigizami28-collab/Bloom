...
## 状態と残件
AUDIT-0.7.0.mdを参照。自動検証済み。この版の実画面・音・物理パッドは未検証。HRT-01の攻撃設計はv0.6.11で開発終了。480ms発光（白化240ms）の実操作は未検証。サブ花・複数ボス・拠点・探索は未実装。実装基準v0.5原文との逐条照合は未完了。
